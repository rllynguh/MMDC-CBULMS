...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 25, 2017 at 06:17 AM
...
INSERT INTO `tbladdress` (`intAddrCode`, `strAddrNum`, `strAddrStreet`, `strAddrDistrict`, `intCityCode`) VALUES
(1, '#', 'awdwa', 'qqw', 1),
(2, 'dawdwa', 'dawdaw', 'dawda', 1),
(3, 'dawdaw', 'dawd', 'dawda', 1),
(4, 'dawdaw', 'dawd', 'daw', 1),
(5, 'daw', 'dw', 'daw', 1),
(6, '1212', '121', '121', 1),
(7, '2121', '212', '2121', 1),
...
(10, 'dawd', 'dawd', 'dwda', 1),
(11, 'daw', 'adwd', 'dawd', 1),
(12, '78', '778', '778877787', 1),
(13, '87878787', '8787878', '7878787', 1),
(14, '4587', '8848', '4', 1),
(15, '48484484', '4884484', '488', 1),
(16, '89', '89', '89', 1),
(17, '89', '89', '98', 1),
(18, '256', 'theStreet', 'barangay', 1),
(19, '1212', 'street', 'banhk', 1),
(20, '1223', 'mystreet', 'barangay', 1),
(21, '123', 'theStreet', 'myBarangay', 1),
(22, '1235', 'street', 'Barangay', 1);
...
--
ALTER TABLE `tbladdress`
  MODIFY `intAddrCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `tblbuilding`
  MODIFY `intBuilCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `tblbusinesstype`
  MODIFY `intBusiTypeCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tblcity`
--
ALTER TABLE `tblcity`
  MODIFY `intCityCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tblfloor`
  MODIFY `intFloorCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `tblparkspace`
  MODIFY `intParkSpaceCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tblregistrationheader`
  MODIFY `intRegiCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `tblrepresentative`
--
ALTER TABLE `tblrepresentative`
  MODIFY `intReprCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `tbltenant`
  MODIFY `intTenaCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `tblunit`
--
ALTER TABLE `tblunit`
  MODIFY `intUnitCode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
