...
<div class="container-fluid">
  <div class="block-header">
    <small>
      DASHBOARD / TRANSACTIONS / CONTRACT RENEWAL
    </small>
  </div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="card">
        <div class="header align-center bg-lime">
          <h2 class="p-t-10 p-b-10">CONTRACT RENEWAL</h2>
        ...
        <div class="body">
          ...
          <fieldset>
            ...
            <div class="form-group form-float col-md-12 col-sm-12 p-t-20">
              ...
              <div class="col-md-12 col-sm-12 col-lg-12">
                <div class="form-line">
                  <label class="form-label">Number of Year/s</label>
                  <select class="form-control show-tick align-center">
                    <option class="text-center">1</option>
                    <option class="text-center">2</option>
                    <option class="text-center">3</option>
        ...
        <fieldset>
          <h5 class="card-inside-title">Terms & Conditions</h5>
          <blockquote cite="http://">
            ...
            <ul type="square">
              <li>
                - The Monthly Rent shall be increased annually by 2% to start on the second (2nd) year of the lease contract as computed in the table of rent.
              </li>
              <li>
                <br>- The SECURITY DEPOSIT previously paid shall likewise be increased appropriately and correspondingly.
              </li>
            </ul>
          </blockquote>
