...
class marketRateController extends Controller
{
    ...
    public function data()
    {
     ...
     ->whereRaw("tblMarketRate.dtmDateAsOf=(SELECT MAX(tblMarketRate.dtmDateAsOf) from tblMarketRate where intCityCode=tblCity.intCityCode) or isnull(tblMarketRate.dtmDateAsOf)")
...
public function store(Request $request)
{
  ...
  $marketRate->save();
  return Response::json("succes store");
}
